...
describe('Service Tests', () => {
    describe('Etagere Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Etagere', async () => {
            ...
            it('should update a Etagere', async () => {
                const returnedFromService = Object.assign(
                    {
                        numero: 1
                    },
            ...
            it('should return a list of Etagere', async () => {
                const returnedFromService = Object.assign(
                    {
                        numero: 1
                    },
            ...
            it('should delete a Etagere', async () => {
