...
import { TransitaireComponent } from 'app/entities/transitaire/transitaire.component';
...
describe('Component Tests', () => {
    describe('Transitaire Management Component', () => {
        let comp: TransitaireComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TransitaireComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.transitaires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
