...
export class TransporteurComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.transporteurService
            ...
            .subscribe(
                (res: HttpResponse<ITransporteur[]>) => this.paginateTransporteurs(res.body, res.headers),
    ...
    registerChangeInTransporteurs() {
        this.eventSubscriber = this.eventManager.subscribe('transporteurListModification', response => this.loadAll());
    }
