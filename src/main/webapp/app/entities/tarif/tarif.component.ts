...
export class TarifComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.tarifService
            ...
            .subscribe(
                (res: HttpResponse<ITarif[]>) => this.paginateTarifs(res.body, res.headers),
    ...
    trackId(index: number, item: ITarif) {
        return item.id;
    }
    ...
    protected paginateTarifs(data: ITarif[], headers: HttpHeaders) {
