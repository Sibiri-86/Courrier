...
export class EtagereComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.etagereService
            ...
            .subscribe(
                (res: HttpResponse<IEtagere[]>) => this.paginateEtageres(res.body, res.headers),
    ...
    trackId(index: number, item: IEtagere) {
        return item.id;
    }

    registerChangeInEtageres() {
        this.eventSubscriber = this.eventManager.subscribe('etagereListModification', response => this.loadAll());
    }
    ...
    protected paginateEtageres(data: IEtagere[], headers: HttpHeaders) {
